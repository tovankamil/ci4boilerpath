...
<div class="row">
    ...
    <div class="col-12 mb-3">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo base_url() ?>/adminimages/input" method="post" enctype="multipart/form-data">
                    ...
                    <div class="formCariDataMitra d-flex mb-4 flex-column flex-sm-row justify-content-center align-items-baseline">
                        ...
                        <input type="text" class="form-control form-control-user mr-2 mb-4" placeholder="Fotografer" name="fotografer">
