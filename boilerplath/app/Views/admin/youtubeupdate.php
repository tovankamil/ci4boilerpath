...
<div class="row">
    ...
    <div class="col-12 mb-3">
        ...
        <div class="card">
            <div class="card-body">
                <?php foreach ($youtubebyids as $youtubebyid) { ?>
                    <form action="<?php echo base_url() ?>/adminyoutube/updateyoutube" method="post" enctype="multipart/form-data">
                        <div class="formCariDataMitra d-flex mb-4 flex-column flex-sm-row justify-content-center align-items-baseline">
                            ...
                            <input type="text" class="form-control form-control-user mr-2 mb-4" placeholder="Judul" name="judul" required value="<?php echo $youtubebyid['judul'] ?>">
                            <input type="hidden" class="form-control form-control-user mr-2 mb-4" name="id" required value="<?php echo $youtubebyid['id'] ?>">
                        </div>
                        <div class="formCariDataMitra d-flex mb-4 flex-column flex-sm-row justify-content-center align-items-baseline">
                        ...
                        <div class="formCariDataMitra d-flex mb-4 flex-column flex-sm-row justify-content-start align-items-baseline">
                            ...
                            <textarea name="keterangan" id="summernote" cols="30" rows="10"><?php echo $youtubebyid['keterangan'] ?></textarea>
                        ...
                        <div class="formCariDataMitra d-flex mb-4 flex-column flex-sm-row justify-content-center align-items-baseline">
                            ...
                            <input type="text" class="form-control form-control-user mr-2 mb-4" placeholder="Link" name="link" value="<?php echo $youtubebyid['link'] ?>">
